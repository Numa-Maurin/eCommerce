...
<?php
    foreach ($tab_u as $u) 
        echo ('<p> <a href="index.php?controller=utilisateur1&action=read&loginUtilisateur='.rawurlencode($u->get('loginUtilisateur')).'" style="color:black"> L\'utilisateur de login '.htmlspecialchars($u->get('loginUtilisateur')).' </a> </p>');
